...
export default () => {
    ...
    <div class=configuration id=manageTemplates>
        ...
        <select title=${"Current Template: " + State.now.selected.template.name} 
                                                    @input=${loadTemplate}>
                    ...
                    return html`
                                                    ...
                                                    <button
                                                    data-icon
                                                    title=" Edit Template" @click=${renderModal.bind(this, 'template' ,
            true)}>
            </button>
            ...
            <!-- Save New Template -->
            <button data-icon title="New Template" @click=${renderModal.bind(this, 'template' , false)}>
            </button>
    ...
    <div class=configuration id=savedIndicator>
        Saved: ${new Date(State?.lastSaved || '')
