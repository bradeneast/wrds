...
(function () {
    ...
    var qa = function () { return i(__makeTemplateObject(["\n\n", "\n\n", "\n\n", "\n"], ["\n\n", "\n\n", "\n\n", "\n"]), c.now.fieldTypes.map(function (a) { return "#preview ." + _(a.name).trim() + "{" + a.css + "}"; }), r.map(function (a) { var b = c.now.globalTypes.find(function (d) { return d.name == a; }); return "#preview ." + _(a).trim() + "{" + (b === null || b === void 0 ? void 0 : b.css) + "}"; }), Object.keys(L).map(function (a) { var b = L[a], d = c.now.globalTypes.find(function (e) { return e.name == b; }); return "#preview " + a + " {" + (d === null || d === void 0 ? void 0 : d.css) + "}"; })); };
    var na = function (a) {
        if (a === void 0) { a = 0; }
        var b = c.nowIndex + a;
    ...
    function _a() {
        ...
        try {
            for (var _e = __values(u.styleEditorPane.querySelectorAll("code")), _f = _e.next(); !_f.done; _f = _e.next()) {
                var a = _f.value;
